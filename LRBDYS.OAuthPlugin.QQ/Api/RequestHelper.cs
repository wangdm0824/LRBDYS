...
namespace LRBDYS.OAuthPlugin.QQ.Api
{
    internal class RequestHelper
    {
        ...
        internal RestRequest CreateTokenRequest(QQConnectConfig config, string code, string state = "")
        {
            ...
            request.AddParameter("callbackurl", config.GetCallBackURL(), ParameterType.UrlSegment);
            return request;
        }
        ...
        internal RestRequest CreateGetLibraryTypeRequest(string appId)
        {
            var request = new RestRequest(Method.GET);
            request.RequestFormat = DataFormat.Json;
            request.Resource = "/weiyun/get_library_type";
