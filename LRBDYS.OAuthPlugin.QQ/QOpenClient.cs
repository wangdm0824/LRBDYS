...
namespace LRBDYS.OAuthPlugin.QQ
{
    /// <summary>
    /// QQ登录 API 入口
    /// </summary>
    ...
    public class QOpenClient
    {
        ...
        {
            var context = new QQContext(verifierCode);
        ...
        public QOpenClient(OAuthToken oAuthToken)
        {
            ...
            var context = new QQContext(oAuthToken);
            restApi = new RestApi(context);
        }
        ...
        /// <returns></returns>
        public WeiboBase AddIdol(string name, string fopenids)
        {
        ...
        /// <returns></returns>
        public WeiboBase DelIdol(string name, string fopenid)
        {
        ...
        /// <returns></returns>
        public List<LibraryType> GetLibraryType()
        {
            var libTypeResult = restApi.GetLibraryType();
            if (libTypeResult != null)
                return libTypeResult.Data.LibraryTypes;
            else
                return null;
